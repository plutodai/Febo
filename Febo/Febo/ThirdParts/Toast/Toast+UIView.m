...
- (void)makeToastActivity:(id)position {
    ...
    UILabel *textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, activityView.frame.size.height-25, activityView.frame.size.width, 20)];
...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if(image != nil) {
        ...
        imageView.frame = CGRectMake((130 - image.size.width)/2, CSToastVerticalPadding, CSToastImageViewWidth, CSToastImageViewHeight);
    }
    ...
    if (title != nil) {
        ...
        NSDictionary *dic = [NSDictionary dictionaryWithObject:[UIFont boldSystemFontOfSize:CSToastFontSize] forKey:NSFontAttributeName];
        CGSize expectedSizeTitle = [title boundingRectWithSize:maxSizeTitle options:NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil].size;
    ...
    if (message != nil) {
        ...
        NSDictionary *dic = [NSDictionary dictionaryWithObject:[UIFont boldSystemFontOfSize:CSToastFontSize] forKey:NSFontAttributeName];
        CGSize expectedSizeMessage = [message boundingRectWithSize:maxSizeMessage options:NSStringDrawingUsesLineFragmentOrigin attributes:dic context:nil].size;
...
//notify
- (void)showNotify:(NSString *)message duration:(CGFloat)interval image:(UIImage *)image
{
    // sanity
    ...
    wrapperView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.9];
    
    if(image != nil) {
        imageView = [[[UIImageView alloc] initWithImage:image] autorelease];
        imageView.contentMode = UIViewContentModeScaleAspectFit;
        imageView.frame = CGRectMake(50, 20, 30, 30);
    }
    ...
    wrapperView.frame = CGRectMake(0.0, 0.0, 130, 100);
    
    if(messageLabel != nil) {
        messageLabel.frame = CGRectMake(0, 60, 130, 30);
        [wrapperView addSubview:messageLabel];
    }
    ...
    [self showToast:wrapperView duration:interval position:@"center"];
}
